...
```{r}
#proof of concept: removing extension from filenames
test_inputFileList<-inputFileList
test_inputFileList<-sub(".csv$", "", test_inputFileList)
print(test_inputFileList)
```
