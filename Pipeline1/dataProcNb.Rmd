...
df<-data.frame(nrow=22088) #initialize empty 22088x0 dataframe for receiving input files
filenameList<-c("../../../gseCSV/GSM1657872_1772078217.C04.csv","../../../gseCSV/GSM1657873_1772078217.C06.csv","../../../gseCSV/GSM1657874_1772078217.C07.csv") #list of input files with full path name and extension 
fnl<-c("GSM1657871_1772078217.C03","GSM1657872_1772078217.C04","GSM1657873_1772078217.C06","GSM1657874_1772078217.C07") #list of input files, but without full path name and extension
...
for (f in fnl){
  ...
  names(df2)[2]<- f #rename second column's header
...
df[1]<-NULL #drop first column (not used)
