...
for i in /scratch/spectre/s/sesm2/SRP/test_trimgalore/*_prin2_1_val_1.fq
do 
fn=$(echo "$(basename "$i")" | awk -F'[_.]' '{print $1}')
$STAR --runThreadN 16 --genomeDir /scratch/spectre/s/sesm2/SRP/genome_directory --readFilesIn /scratch/spectre/s/sesm2/SRP/trimgalore_out/"$fn"_prin2_1_val_1.fq /scratch/spectre/s/sesm2/SRP/trimgalore_out/"$fn"_prin2_2_val_2.fq --outFileNamePrefix /scratch/spectre/s/sesm2/SRP/STAR_out/"$fn"_STAR_ \-outFilterType BySJout \--outFilterMultimapNmax 20 \-- alignSJoverhangMin 8 \--alignSJDBoverhangMin 1 \--outFilterMismatchNmax 999 \--outFilterMismatchNoverLmax 0.04 \--alignIntronMin 20 \--alignIntronMax 1000000 \--alignMatesGapMax 1000000 \--outSAMstrandField intronMotif
done
